        ...
        <div className='pt-6'>
          <div className='card sm:card-side bg-base-200 shadow-xl'>
            ...
            <div className='card-body'>
              ...
              <p>
                You can store all types of sensitive data here, transmit it securely to anyone, and do so much more. Get
                started by adding a credential or a note to your vault.
              </p>
            </div>
          </div>
        </div>
